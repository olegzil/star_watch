...
-asn1_info([{vsn,'5.0.19'},
            {module,'OTP-PUB-KEY'},
            {options,[{i,"/root/deb/otp/lib/public_key/asn1/../src"},
 warnings,ber,errors,
 {cwd,"/root/deb/otp/lib/public_key/asn1"},
 {outdir,"/root/deb/otp/lib/public_key/asn1/../src"},
 asn1config,noobj,der,
 {i,"."},
 {i,"/root/deb/otp/lib/public_key/asn1"}]}]).
